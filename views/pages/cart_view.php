...
<!-- TODO move this styles to css file -->
<style>
img {
    margin-left: 15px;
    max-height: 225px;
    ...
    <section id="donation-cart" class="projects-list">
        ...
        <?php foreach ($islamic_payments as $islamic_payment): ?>
            ...
            <img src="views/media/images/<?= htmlspecialchars($islamic_payment['photo'] ?? "11.png") ?>" alt=" حملة " loading="lazy">
                <div class="project-details">
                    <h3>الرقم:<?= htmlspecialchars($islamic_payment['islamic_payment_id']) ?></h3>
                    <h3>النوع:<?= htmlspecialchars($islamic_payment['name']) ?></h3>
                    <p>الوصف : <?= htmlspecialchars($islamic_payment['short_description']) ?></p>
                    <div class="input_delet">
                        <div class="donate-section">
