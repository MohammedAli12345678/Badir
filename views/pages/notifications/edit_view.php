      ...
      <div class="modal-content">
        ...
        <form id="add-notification-form" action="/notifications_update" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <h6 class="error_mseage"> <?= !empty($errors['title']) ? 'خطأ : ' . $errors['title'] : '' ?></h6>
          </div>
          <div class="form-group">
            ...
            <h6 class="error_mseage"> <?= !empty($errors['content']) ? 'خطأ : ' . $errors['content'] : '' ?></h6>
          </div>
          <div class="form-group">
            ...
            <h6 class="error_mseage"> <?= !empty($errors['send_at']) ? 'خطأ : ' . $errors['send_at'] : '' ?></h6>
          </div>
          <div class="form-group">
